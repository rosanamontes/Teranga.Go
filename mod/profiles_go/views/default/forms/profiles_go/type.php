...
$form_title = elgg_echo('profiles_go:profile_types:add');
...
if ($vars["entity"]) {
	...
	$form_title = elgg_echo('profiles_go:profile_types:edit');
...
$formbody .= elgg_echo('profiles_go:admin:metadata_name') . ":";
$formbody .= elgg_view('input/text', array('name' => 'metadata_name', "value" => $metadata_name));

$formbody .= elgg_echo('profiles_go:admin:metadata_label') . "*:";
...
$form = elgg_view('input/form', array('body' => $formbody, 'action' => 'action/profiles_go/profile_types/add'));
