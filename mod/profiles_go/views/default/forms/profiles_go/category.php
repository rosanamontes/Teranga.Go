...
$form_title = elgg_echo('profiles_go:categories:add');
...
if ($vars["entity"]) {
	...
	$form_title = elgg_echo('profiles_go:categories:edit');
...
$form = elgg_view('input/form', array('body' => $formbody, 'action' => 'action/profiles_go/categories/add'));
