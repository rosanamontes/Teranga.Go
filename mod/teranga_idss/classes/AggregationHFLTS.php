...
class AggregationHFLTS extends MCDM
{
	...
	public function run()
	{
		...
		//Get the scenario  .-..-..-..-..-..-..-..-..-..-..-..-..-..-..-..-..-..-..-..-..-..-..-..- 
		if (elgg_get_plugin_setting('weight_experts', 'teranga_idss') == 1)
		{
			if (elgg_get_plugin_setting('weight_assessments', 'teranga_idss') == 1)
			{
		...
		{
			if (elgg_get_plugin_setting('weight_assessments', 'teranga_idss') == 0)
