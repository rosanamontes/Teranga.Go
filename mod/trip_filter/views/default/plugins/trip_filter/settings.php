...
*	
*	File: Plugin settings for trip filter
*/

$plugin = elgg_extract('entity', $vars);

$listing_options = [
	'yours' => elgg_echo('mytrips:yours'),
	//'newest' => elgg_echo('sort:newest'), => es la opcion por defecto!
	//'popular' => elgg_echo('sort:popular'),
	'open' => elgg_echo('trip_filter:trips:sorting:open'),
	'closed' => elgg_echo('trip_filter:trips:sorting:closed'),
	//'alpha' => elgg_echo('sort:alpha'),
	'ordered' => elgg_echo('trip_filter:trips:sorting:ordered'),
	'featured' => elgg_echo('status:featured'),
	'suggested' => elgg_echo('trip_filter:trips:sorting:suggested'),//Rosana: el que voy a implementar
	'discussion' => elgg_echo('mytrips:latestdiscussion'),
];

$body .= '<div>';
$body .= elgg_echo('trip_filter:settings:listing:default');
$body .= elgg_view('input/select', [
	'name' => 'params[trip_listing]',
	'options_values' => $listing_options,
	'value' => $plugin->trip_listing,
	'class' => 'mls',
]);
$body .= '</div>';

$body .= '<div>';
$body .= elgg_echo('trip_filter:settings:listing:available');
$body .= '<ul class="mll">';

foreach ($listing_options as $tab => $tab_title) 
{
	$tab_setting_name = "trip_listing_{$tab}_available";
	$checkbox_options = [
