...
if (($n - $skipped) == 0) {
	register_error(elgg_echo("profiles_go:actions:import:from_custom:no_fields"));
} else {
	system_message(elgg_echo("profiles_go:actions:import:from_custom:new_fields", array($n - $skipped)));
}
