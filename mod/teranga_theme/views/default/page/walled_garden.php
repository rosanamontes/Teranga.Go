...
<h1>
    ...
    <img style="width: 100%; height: auto;" src="<?php echo elgg_get_site_url(); ?>/mod/teranga_theme/graphics/headimg.jpg" />
</div>
</div>
...
<?php include elgg_get_data_path() . "teranga_theme/textleft.php"; ?> 
</div>
    </div>
	</div>
<div class="elgg-col elgg-col-1of2">
