...
$form_title = elgg_echo('profiles_go:profile_fields:add');
...
if ($vars["entity"]) {
	...
	$form_title = elgg_echo('profiles_go:profile_fields:edit');
...
$formbody .= "<br />" . elgg_echo('profiles_go:admin:metadata_options') . "*:" . elgg_view('input/text', array('name' => 'metadata_options', "value" => $metadata_options));

$formbody .= "<div class='elgg-module elgg-module-inline'><div class='elgg-head'><h3>" . elgg_echo("profiles_go:admin:additional_options") . "<span class='custom_fields_more_info' id='more_info_profile_field_additional'></span></h3></div><div class='elgg-body'>";
$formbody .= "<table>";
...
$formbody .= "<tr>";
$formbody .= "<td>" . elgg_echo('profiles_go:admin:show_on_register') . ":</td>";
...
$formbody .= "<td>" . elgg_echo('profiles_go:admin:show_on_register:description') . "</td>";
$formbody .= "</tr>";
...
$formbody .= "<tr>";
$formbody .= "<td>" . elgg_echo('profiles_go:admin:mandatory') . ":</td>";
...
$formbody .= "<td>" . elgg_echo('profiles_go:admin:mandatory:description') . "</td>";
$formbody .= "</tr>";
...
$formbody .= "<tr>";
$formbody .= "<td>" . elgg_echo('profiles_go:admin:user_editable') . ":</td>";
...
$formbody .= "<td>" . elgg_echo('profiles_go:admin:user_editable:description') . "</td>";
$formbody .= "</tr>";
...
elgg.profiles_go.change_field_type();
</script>