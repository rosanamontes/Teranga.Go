<?php
$plugin_graphics_folder = elgg_get_site_url() . "mod/profiles_go/graphics/";
?>
/* widgets */
...
.profiles_go_profile_edit_tab_content,
...
.profiles_go_register_input_container {
	white-space:nowrap; /* required for outlining in IE7 */
}

.profiles_go_register_input_container > input {
	padding-right: 25px;
}

/* extra explicit for IE7 */
.elgg-icon.profiles_go_validate_icon {
	margin-left: -22px;
    margin-top: 8px;
    position: absolute;
    display: none;
...
.elgg-icon.profiles_go_validate_icon_loading {
	background-image: url(<?php echo $plugin_graphics_folder; ?>loading.gif);
	display: inline-block;
	
}
.elgg-icon.profiles_go_validate_icon_valid {
	background-position: 0 -126px;
	display: inline-block;
}

.elgg-icon.profiles_go_validate_icon_invalid {
...
/* registration field */
#profiles_go_register_left {
	float: left;
	width: 450px;
}

#profiles_go_register_right {
	float: right;
	width: 450px;
}

#profiles_go_register_right > fieldset {
	margin-top: 10px;
}

/* registration form mandatory fields */

.profiles_go_register_missing {
