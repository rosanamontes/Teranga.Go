...
echo elgg_echo('profiles_go:export:description:' . CUSTOM_PROFILE_FIELDS_PROFILE_SUBTYPE);

$form = elgg_view_form("profiles_go/export", array(), array("fieldtype" => CUSTOM_PROFILE_FIELDS_PROFILE_SUBTYPE));
