...
$title = elgg_echo("profiles_go:user_summary_control:config");

$add_icon = "<span class='elgg-icon elgg-icon-profile-manager-user-summary-config-add' title='" . elgg_echo("add") . "'></span>";

$form_body = "<span class='elgg-subtext'>" . elgg_echo("profiles_go:user_summary_control:info") . "</span>";
...
$form_body .= $add_icon . " <span class='profile-manager-user-summary-config-container-info'>" . elgg_echo("profiles_go:user_summary_control:container:title") . "</span>";
...
$form_body .= $add_icon . " <span class='profile-manager-user-summary-config-container-info'>" . elgg_echo("profiles_go:user_summary_control:container:entity_menu") . "</span>";
$form_body .= "</td>";
$form_body .= "</tr>";
...
$form_body .= $add_icon . " <span class='profile-manager-user-summary-config-container-info'>" . elgg_echo("profiles_go:user_summary_control:container:subtitle") . "</span>";
$form_body .= "</td></tr>";
...
$form_body .= $add_icon . " <span class='profile-manager-user-summary-config-container-info'>" . elgg_echo("profiles_go:user_summary_control:container:content") . "</span>";
$form_body .= "</td></tr>";
...
$body = elgg_view("input/form", array("body" => $form_body, "action" => "action/profiles_go/user_summary_control/save"));
